...
const FileInput = ({ file, className, type, onChange }: FileInputProps): JSX.Element => <Dropzone
...
>
  {file &&
    <FileReference
      className='app-FileInput-file' type={type} file={file} onRemove={onChange && (() => onChange(undefined))}/>
  }
  {!file && [
